...
const en = {
  ...
  'activeWorkout.doneThisWeek': 'Done this week',
  'activeWorkout.nextUp': 'Next up',
  'activeWorkout.startDayAria': 'Start {name}, {day}',
  ...
  'programs.form.copyDayAria': 'Copy Day {n} to other days',
  ...
  'routines.expandFolder': 'Show {folder}',
  'routines.collapseFolder': 'Hide {folder}',
  'routines.routineCount': '{n} routine|{n} routines',
