...
const de: Record<TKey, string> = {
  ...
  'activeWorkout.doneThisWeek': 'Diese Woche erledigt',
  'activeWorkout.nextUp': 'Als Nächstes',
  'activeWorkout.startDayAria': '{name} starten, {day}',
  ...
  'programs.form.copyDayAria': 'Tag {n} zu anderen Tagen kopieren',
  ...
  'routines.expandFolder': '{folder} anzeigen',
  'routines.collapseFolder': '{folder} ausblenden',
  'routines.routineCount': '{n} Plan|{n} Pläne',
